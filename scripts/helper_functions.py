...
def process_huc_data(huc12_name, point_gdf_proj, elevation, elevation_dataset, elevation_band, fd_10_dataset, fd_100_dataset, 
...
def mask_and_mean(dataset, geometries, nodata=-9999):
    ...
    data = out[0]
    data = data[(data != -9999.0) & (data != -9998.0)]
